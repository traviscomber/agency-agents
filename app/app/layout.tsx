...
export default function AppLayout({ children }: { children: React.ReactNode }) {
  return (
    <OnboardingProvider>
      <OnboardingWelcome />
      <PublicNavbar />
      <div className="n3-app-shell relative flex min-h-screen overflow-hidden pt-[4.75rem]" style={{ backgroundColor: '#f1f6f4' }}>
        <div className="pointer-events-none absolute inset-0">
          ...
          <div className="absolute right-[-10%] top-24 h-72 w-72 bg-[radial-gradient(circle,_rgba(23,54,52,0.08),_transparent_70%)] blur-3xl" />
        </div>
        <AppSidebar />
