    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 py-8 sm:py-10">
      <div className="rounded-[28px] border border-border/70 bg-gradient-to-br from-white via-white to-muted/30 p-6 sm:p-8 shadow-[0_18px_60px_-44px_rgba(15,23,42,0.45)]">
        <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
          ...
          <div className="grid grid-cols-3 gap-3 sm:min-w-[360px]">
            ...
            <div className="rounded-2xl border border-border bg-white/80 p-3">
              <p className="text-[11px] uppercase tracking-[0.2em] text-muted-foreground">Done</p>
              <p className="mt-1 text-2xl font-semibold text-foreground">{completedRuns}</p>
            </div>
            <div className="rounded-2xl border border-border bg-white/80 p-3">
              <p className="text-[11px] uppercase tracking-[0.2em] text-muted-foreground">Failed</p>
      ...
      {MOCK_RUNS.length === 0 ? (
        ...
        <div className="mt-6 grid gap-4 xl:grid-cols-[1.15fr_0.85fr]">
          <div className="rounded-[28px] border border-border bg-white p-5 sm:p-6 overflow-hidden">
            <div className="flex items-center justify-between border-b border-border pb-4">
              <div>
                <h2 className="text-sm font-semibold text-foreground">Timeline</h2>
                <p className="mt-1 text-xs text-muted-foreground">Most recent execution first.</p>
              </div>
