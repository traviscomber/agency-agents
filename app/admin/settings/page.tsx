    ...
    <div className="mx-auto max-w-3xl px-4 py-8 sm:px-6">
      ...
      <div className="mt-6 space-y-8">
        <section className="rounded-[1.75rem] border border-slate-200 bg-white p-5 shadow-[0_12px_36px_-30px_rgba(15,23,42,0.45)]">
          ...
          <div className="space-y-4 rounded-2xl border border-slate-200 bg-[linear-gradient(180deg,#ffffff_0%,#f8fafc_100%)] p-5 shadow-sm">
          ...
          <div className="space-y-4 rounded-2xl border border-slate-200 bg-[linear-gradient(180deg,#ffffff_0%,#f8fafc_100%)] p-5 shadow-sm">
            ...
            <div className="flex items-center justify-between rounded-2xl border border-slate-200 bg-white p-4">
              <div>
                ...
                <p className="text-xs text-slate-700">Block all non-admin users from accessing the app.</p>
              </div>
              <button className="relative h-5 w-9 shrink-0 rounded-full border border-slate-200 bg-slate-100">
                <span className="absolute left-1 top-1 h-3 w-3 rounded-full bg-slate-600/60" />
              </button>
            </div>
            <div className="flex items-center justify-between rounded-2xl border border-slate-200 bg-white p-4">
              <div>
                <p className="text-sm font-medium text-foreground">New user signups</p>
                <p className="text-xs text-slate-700">Allow new users to register. Disable for invite-only mode.</p>
              </div>
