...
export const pricingPageCopy = {
  es: {
    ...
    title: 'Precio de programas operativos por rol, no solo de corridas aisladas.',
    summary:
      'Parte gratis y sube de plan cuando necesites mas capacidad operativa por rol: memoria, handoffs, supervision, automatizacion y ROI visible en Chile y Latam.',
    valueStack: [
      ['Pagas por capacidad operativa', 'Los planes escalan cuando necesitas mas roles desplegados, mas rutinas concurrentes y mas memoria por cuenta.'],
      ['Pagas por replacement supervisado', 'El valor no es mas volumen. Es mas control sobre lo que el twin absorbe y lo que aun necesita aprobacion humana.'],
      ['Pagas por programas acumulables', 'Los planes altos desbloquean secuencias, automatizaciones y handoffs multi-rol que se acumulan en el tiempo.'],
    ],
    metrics: [
      ['Tiempo', 'Horas recuperadas por semana en roles repetitivos'],
      ['Control', 'Estado operativo guardado y continuidad por cuenta'],
      ['Replacement', 'Handoffs, controles y cobertura de escalamiento'],
    ],
    bestFit: 'Mejor calce para programa operativo',
    twinCapacity: 'Capacidad de gemelos',
    unlimitedTwinExecution: 'Ejecucion de gemelos ilimitada',
    runsPerMonth: 'ejecuciones supervisadas por mes',
    unlimitedPrograms: 'Programas operativos ilimitados',
    activePrograms: 'programas activos',
    faqEyebrow: 'Preguntas comunes',
    faqTitle: 'El plan debe calzar con tu ambicion operativa, no con el hype.',
    readyEyebrow: 'Listo para empezar',
    readyTitle: 'Despliega el primer programa operativo antes de escalar el sistema.',
    ...
    faq: [
      ...
      ['Que pasa al llegar al limite?', 'Starter o superior puede ampliar capacidad de ejecucion supervisada. Free se detiene en el limite mensual para mantener control de costo.'],
      ...
      ['Puedo usar programas multi-step?', 'Si, en Pro o superior. Encadena gemelos digitales y aprobaciones humanas cuando el trabajo requiere revision y handoff.'],
  ...
  en: {
    ...
    title: 'Price operating programs by role, not just isolated runs.',
    summary:
      'Start with a diagnosis, then upgrade when you need more operating capacity by role: memory, handoffs, supervision, automation, and visible ROI across Chile and Latam.',
    valueStack: [
      ['Pay for operating capacity', 'Plans scale when you need more deployed roles, more concurrent routines, and more memory by account.'],
      ['Pay for supervised replacement', 'The value is not more volume. It is clearer control over what the twin absorbs and what still needs human approval.'],
      ['Pay for compound programs', 'Higher plans unlock sequencing, automation, and multi-role handoffs that compound over time.'],
    ],
    metrics: [
      ['Time', 'Hours recovered each week from repetitive roles'],
      ['Control', 'Saved operating state and account continuity'],
      ['Replacement', 'Handoffs, controls, and escalation coverage'],
    ],
    bestFit: 'Best operating program fit',
    twinCapacity: 'Twin capacity',
    unlimitedTwinExecution: 'Unlimited twin execution',
    runsPerMonth: 'supervised routine executions per month',
    unlimitedPrograms: 'Unlimited operating programs',
    activePrograms: 'active programs',
    faqEyebrow: 'Common questions',
    faqTitle: 'The plan should match your operating ambition, not the hype.',
    readyEyebrow: 'Ready to start',
    readyTitle: 'Deploy the first operating program before you scale the system.',
    ...
    faq: [
      ...
      ['What happens when I hit the execution limit?', 'Starter and higher plans can expand supervised execution capacity. Free stops at the monthly limit to keep cost controlled.'],
      ['Do you offer annual discounts?', 'Yes. Contact sales for Enterprise plans to discuss annual billing and volume discounts.'],
      ['Which plan includes scheduled automation?', 'Starter and higher. Use scheduled routines when the twin needs recurring reporting, monitoring, or repeatable operational passes.'],
      ['Can I use multi-step twin programs?', 'Yes, on Pro and higher. Chain twins and human approvals when the work requires review, handoff, or sequencing rather than a single isolated execution.'],
...
export const authPageCopy = {
  signup: {
    ...
    en: {
      ...
      benefits: [
        '5 free supervised routine executions per month',
        'Program memory and workflow continuity',
