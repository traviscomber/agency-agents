...
export const MOCK_RUNS: AgentRun[] = [
  {
    ...
    task: 'Define the MVP scope for N3uralia Studio, an operating workspace with specialized AI systems',
    context: 'Target users are founders, developers, and consultants. Budget is limited.',
    desiredOutput: 'product_brief',
    detailLevel: 'detailed',
    output: {
      summary:
        'N3uralia Studio should focus on a curated specialist library with a seamless run-and-save workflow. Core value: operational continuity, not generic chat.',
      mainResult:
  ...
  },
  {
    ...
    task: 'Define the ICP for N3uralia Studio and build an outreach framework',
...
export const MOCK_SAVED_OUTPUTS: SavedOutput[] = [
  {
    ...
    agentRunId: 'run-001',
    agentName: 'Product Strategist',
    title: 'N3uralia Studio Scope — Product Brief',
