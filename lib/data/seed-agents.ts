...
export const SEED_AGENTS: Agent[] = [
  {
    ...
    twinProfile: {
      ...
      businessProblem: 'Pipeline disperso, follow-up inconsistente y perdida de contexto entre reunion, propuesta y cierre.',
      expectedSavings: '5-8 h/semana por ejecutivo comercial.',
      firstResult: 'Agenda priorizada, proximos pasos por cuenta y 3 follow-ups listos para revision.',
      needsApprovalFor: ['Descuentos o cambios de precio', 'Propuestas finales', 'Compromisos contractuales'],
      doesNotDo: ['No negocia condiciones finales', 'No aprueba contratos', 'No promete plazos sin owner humano'],
    },
  ...
  },
  {
    ...
    twinProfile: {
      ...
      businessProblem: 'Bases extensas, requisitos dispersos y decision go/no-go lenta antes de invertir horas del equipo.',
      expectedSavings: 'Primer barrido documental en 15-30 minutos por licitacion.',
      firstResult: 'Go/no-go, checklist documental, riesgos y responsables para firma humana.',
      needsApprovalFor: ['Decision final de postular', 'Interpretacion legal sensible', 'Oferta economica'],
      doesNotDo: ['No firma documentos', 'No reemplaza revision legal', 'No define precio final'],
    },
    planRequired: 'pro',
    isFeatured: true,
    isActive: true,
  },
  {
    ...
    twinProfile: {
      ...
      supervisionLevel: 'medium',
      businessProblem: 'Cartera vencida sin priorizacion, promesas de pago perdidas y seguimiento manual poco trazable.',
      expectedSavings: '30-50 h/mes recuperables en seguimiento y priorizacion.',
      firstResult: 'Ranking de cuentas, mensajes sugeridos, promesas detectadas y casos para escalar.',
      needsApprovalFor: ['Convenios de pago especiales', 'Bloqueos de servicio', 'Escalamiento legal'],
      doesNotDo: ['No amenaza clientes', 'No renegocia deuda sin politica', 'No ejecuta acciones legales'],
    },
    planRequired: 'starter',
    isFeatured: true,
    isActive: true,
  },
  {
    ...
    twinProfile: {
      ...
      supervisionLevel: 'medium',
      businessProblem: 'Implementaciones con acuerdos dispersos, bloqueos invisibles y handoffs debiles entre venta, delivery y cliente.',
      expectedSavings: '4-7 h/semana por PM en minutas, seguimiento y orden de riesgos.',
      firstResult: 'Minuta ejecutiva, matriz de riesgos, owners y proximo hito por cliente.',
      needsApprovalFor: ['Cambio de alcance', 'Fecha final comprometida', 'Escalamiento ejecutivo'],
      doesNotDo: ['No cambia contratos', 'No reprioriza roadmap sin sponsor', 'No promete delivery sin equipo'],
    },
    planRequired: 'pro',
    isFeatured: true,
    isActive: true,
  },
  {
    ...
    twinProfile: {
      ...
      supervisionLevel: 'medium',
      businessProblem: 'Vacantes con candidatos dispersos, screening manual y poca continuidad entre entrevistas.',
      expectedSavings: '20-35 h/mes en screening inicial y seguimiento de candidatos.',
      firstResult: 'Shortlist ordenada, riesgos por candidato y pauta de entrevista para decision humana.',
      needsApprovalFor: ['Seleccion final', 'Oferta laboral', 'Evaluaciones sensibles'],
      doesNotDo: ['No discrimina por atributos protegidos', 'No decide contratacion final', 'No negocia renta sin recruiter'],
    },
    planRequired: 'starter',
    isFeatured: true,
    isActive: true,
