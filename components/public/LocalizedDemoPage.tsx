...
export function LocalizedDemoPage({ locale }: { locale: MarketingLocale }) {
  const copy = {
    es: {
      ...
      body: 'Cada recorrido muestra el dolor, los datos necesarios, la rutina del gemelo, el output esperado, el nivel de supervision y el ROI operativo antes de crear el programa.',
    ...
    en: {
      ...
      body: 'Each walkthrough shows the pain, required data, twin routine, expected output, supervision level, and operating ROI before creating the program.',
